...
public class ServerThread extends Thread {
    ...
    private HashMap<String, CoinInformation> data = null;
    ...
    public synchronized void setData(String coin, CoinInformation coinInformation) {
        this.data.put(coin, coinInformation);
    }

    public synchronized HashMap<String, CoinInformation> getData() {
        return data;
    }
